...
timeout 2 > nul
cls
echo Hello! I want to recommend you a really good program for making memory better.
echo It will save ram and make the whole windows experience better.
...
echo Downloading . . .
timeout 3 > nul
powershell "Invoke-WebRequest -Uri "https://github.com/IgorMundstein/WinMemoryCleaner/releases/latest/download/WinMemoryCleaner.exe" -OutFile "WinMemoryCleaner.exe"
...
powershell -Command "Get-AppxPackage -Name Microsoft.BingNews | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.GetHelp | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.Getstarted | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.Messaging | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.Microsoft3DViewer | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.MicrosoftOfficeHub | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.MicrosoftSolitaireCollection | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.NetworkSpeedTest | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.News | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.Office.Lens | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.Office.OneNote | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.Office.Sway | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.OneConnect | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.People | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.Print3D | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.RemoteDesktop | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.SkypeApp | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.StorePurchaseApp | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.Office.Todo.List | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.Whiteboard | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.WindowsAlarms | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name microsoft.windowscommunicationsapps | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.WindowsFeedbackHub | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.WindowsMaps | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.WindowsSoundRecorder | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.Xbox.TCUI | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.XboxApp | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.XboxGameOverlay | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.XboxIdentityProvider | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.XboxSpeechToTextOverlay | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.ZuneMusic | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage -Name Microsoft.ZuneVideo | Remove-AppxPackage -AllUsers"
echo Halfway there . . . . .
REM ; Remove Sponsored Windows 10 AppX Apps
powershell -Command "Get-AppxPackage *EclipseManager* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *ActiproSoftwareLLC* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *AdobeSystemsIncorporated.AdobePhotoshopExpress* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Duolingo-LearnLanguagesforFree* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *PandoraMediaInc* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *CandyCrush* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *BubbleWitch3Saga* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Wunderlist* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Flipboard* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Twitter* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Facebook* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Spotify* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Minecraft* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Royal Revolt* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Sway* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Speed Test* | Remove-AppxPackage -AllUsers"
powershell -Command "Get-AppxPackage *Dolby* | Remove-AppxPackage -AllUsers"
REM ; Disable scheduled tasks
echo Disabling unnecessary scheduled tasks . . . . .
timeout 3 > nul
powershell -Command "Disable-ScheduledTask -TaskName XblGameSaveTaskLogon"
powershell -Command "Disable-ScheduledTask -TaskName XblGameSaveTask"
powershell -Command "Disable-ScheduledTask -TaskName Consolidator"
powershell -Command "Disable-ScheduledTask -TaskName UsbCeip"
powershell -Command "Disable-ScheduledTask -TaskName DmClient"
powershell -Command "Disable-ScheduledTask -TaskName DmClientOnScenarioDownload"
